/**
 * Technocracy Web Audio API Sound Synthesizer Engine
...
class SoundEngine {
  ...
  // Deep Zen Temple Gong / Bell for Entrance and Milestones
  playZenGong() {
    ...
    freqs.forEach((f, idx) => {
      ...
      gain.gain.exponentialRampToValueAtTime(amp, t + 0.04);
      gain.gain.exponentialRampToValueAtTime(0.0001, t + decay + (idx * 0.3));

      osc.connect(gain);
      gain.connect(this.masterGain);

      osc.start(t);
      osc.stop(t + decay + 0.8);
    });
  }

  // Harmonic Pentatonic Chime for Trigram and Card selection
